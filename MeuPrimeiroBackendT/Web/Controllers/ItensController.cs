...
namespace Web.Controllers
{
    public class ItensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,Nome,Descricao,qualidade,DanoBase,TipoItemID")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,Nome,Descricao,qualidade,DanoBase,TipoItemID")] Item item)
        {
            if (ModelState.IsValid)
            {
